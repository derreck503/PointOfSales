...
$sql = $db->query("SELECT QtyInStock FROM POSDB.Product");
    if($sql->num_rows){
      echo "Executed sql query to get stock";
    $InventoryPopup = $sql->fetch_all(MYSQLI_ASSOC);
    foreach($InventoryPopup as $Check){
      echo "Checking inventory";
      if ($Check['QtyInStock'] > 10) {
        echo "inventory is > 10";
       $dummy = 0;
           }
    }

    $Warning = "The following products have low inventory levels. Please restock.";
?>
